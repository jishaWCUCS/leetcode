...
public class SortE {
    ...
    public static void main(String[] args) {
        ...
        Map<Double, List<Employee>> hmap = empList.stream().collect(Collectors.groupingBy(Employee::getRating));
        System.out.println("emp Group By Rating ");
